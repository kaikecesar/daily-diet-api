...
const sampleMeals = [
  ...
  },
  {
    ...
    description: 'Café reforçado pré-treino',
    isOnDiet: true,
  },
  {
    name: 'Pão francês com requeijão',
    description: 'Quebrou a dieta no café',
    isOnDiet: false,
  },
  {
    name: 'Frango grelhado com salada',
    description: 'Almoço limpo',
    isOnDiet: true,
  },
  {
    name: 'Arroz integral com atum',
    description: 'Almoço pós-treino',
    isOnDiet: true,
  },
  {
    name: 'Hambúrguer artesanal',
    description: 'Fim de semana com os amigos',
    isOnDiet: false,
  },
  {
  ...
  {
    name: 'Batata doce com patinho',
    description: 'Almoço de bulking',
    isOnDiet: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Jantar rico em ômega 3',
    isOnDiet: true,
  },
  {
    name: 'Shake de whey com aveia',
    description: 'Pré-treino rápido',
    isOnDiet: true,
  },
  { name: 'Brigadeiro', description: 'Aniversário do colega', isOnDiet: false },
  {
    name: 'Tapioca com ovo',
    description: 'Café da manhã leve',
    isOnDiet: true,
  },
  { name: 'Sopa de legumes', description: 'Jantar leve', isOnDiet: true },
  {
    name: 'Açaí com leite condensado',
    description: 'Sobremesa calórica',
    isOnDiet: false,
  },
  {
    name: 'Peito de peru com queijo branco',
    description: 'Lanche da tarde',
    isOnDiet: true,
  },
  {
    name: 'Macarrão à bolonhesa',
    description: 'Almoço integral',
    isOnDiet: true,
  },
  {
    name: 'Coxinha de padaria',
    description: 'Lanche fora do plano',
    isOnDiet: false,
  },
  {
    name: 'Ovos mexidos com abacate',
    description: 'Café low-carb',
    isOnDiet: true,
  },
  {
    name: 'Wrap de frango com homus',
    description: 'Almoço prático',
    isOnDiet: true,
  },
  ...
  },
  {
    ...
    description: 'Jantar vegetariano',
    isOnDiet: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Café alto em proteína',
    isOnDiet: true,
  },
  ...
  { name: 'Sorvete de chocolate', description: 'Sobremesa', isOnDiet: false },
  {
    ...
    description: 'Almoço clássico',
    isOnDiet: true,
  },
  {
    name: 'Grão de bico com atum',
    description: 'Jantar rápido',
    isOnDiet: true,
  },
  {
    name: 'Refrigerante com pastel',
